<?php
    ...
    if( $file == "" )
    {
        $sql = "update product set name = '" . $name . "' , `condition` = '" . $condition . "' , price = " . $price . " , year = " . $year . " , amount = " . $amount . " , description = '" . $description . "' where PID = " . $PID . ";" ;
    }else{
        $sql = "update product set name = '" . $name . "' , image = '" . $file . "' , `condition` = '" . $condition . "' , price = " . $price . " , year = " . $year . " , amount = " . $amount . " , description = '" . $description . "' where PID = " . $PID . ";" ;
    }
